...
function update_graph_data_query_cache($local_graph_id, $host_id = '', $data_query_id = '', $previous_index = '') {
    //cacti_log("更新图形的query_cache， local_graph_id = " .$local_graph_id . " host_id = " .$host_id . " data_query_id = " . $data_query_id . " previous_index = " . $previous_index);
	...
	//cacti_log("current_index = " . $current_index . " fields = " . json_encode($field) . " data_query_id = " . $data_query_id);
...
function update_data_source_data_query_cache($local_data_id, $host_id = '', $data_query_id = '', $previous_index = '') {
    //cacti_log("更新数据源query_cache， local_data_id = " .$local_data_id . " host_id = " .$host_id . " data_query_id = " . $data_query_id . " previous_index = " . $previous_index);
    global $data_query_id_cache;
