...
function update_show_current () {
	...
	if (cacti_sizeof($plugins)) {
		...
		foreach ($plugins as $plugin) {
		    ...
		    if($name == "report" && $_SESSION["sess_report_status"] == "off"){
		      continue;
		    }
		    if($name == "assets" && $_SESSION["sess_assets_status"] == "off"){
		      continue;
		    }
		    if($name == "overview" && $_SESSION["sess_overview_status"] == "off"){
		      continue;
		    }
		    if($name == "qunee" && $_SESSION["sess_qunee_status"] == "off"){
		      continue;
            }
