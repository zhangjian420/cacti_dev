...
$fields_user_user_edit_host = array(
    ...
    'user_auth_group_id' => array(
        'method' => 'drop_sql',
        'friendly_name' => "用户组",
        'description' => "用户所在用户组",
        'default' => '0',
        'value' => '|arg1:user_auth_group_id|',
        'sql' => 'select 0 as id,"无" as name union all SELECT id, name FROM user_auth_group ORDER BY id desc',
    ),
    'enabled' => array(
        'method' => 'checkbox',
    ...
    'white_ips' => array(
        ...
        'textarea_rows' => '3',
        'textarea_cols' => '70',
        'description' => "设置允许该用户登录的IP，仅支持掩码格式，以英文逗号分隔",
        'value' => '|arg1:white_ips|',
        'max_length' => '255',
        'class' => 'textAreaNotes'
    ),
	'grp1' => array(
...
$struct_aggregate = array(
	...
	'aggregate_graph_type' => array(
	    ...
	    'default' => AGGREGATE_GRAPH_TYPE_KEEP,
	),
