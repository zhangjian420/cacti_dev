...
$settings = array(
	...
	'general' => array(
	    ...
	    'company_name' => array(
	        'friendly_name' => __('企业名称'),
	        'description' => __('授权企业名称，修改后需要重新授权'),
	        'method' => 'textbox',
	        'default' => '',
	        'max_length' => '128',
	    ),
	...
	'data' => array(
		...
		'storage_time' => array(
	        	'friendly_name' => __('数据保留时间'),
	        	'description' => __('历史数据保留时间'),
	        	'method' => 'drop_array',
	        	'default' => '1',
	        	'array' => $dsstats_storage_time
	    	),
	    	'database_bak_time' => array(
	        	'friendly_name' => __('数据库定时备份时间'),
	        	'description' => __('每天什么时间备份数据库'),
	        	'method' => 'drop_array',
	        	'default' => '1',
	        	'array' => $dsstats_database_bak_time
	    	),
