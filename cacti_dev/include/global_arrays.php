...
if ($config['poller_id'] == 1 || $config['connection'] == 'online') {
    $menu = array(
        ...
        __('Templates') => array(
            'host_templates.php'      => __('设备模板'),
            'graph_templates.php'     => __('图形模板'),
            'data_templates.php'      => __('数据源模板'),
            'aggregate_templates.php' => __('聚合模板'),
            'color_templates.php'     => __('颜色模板')
        ),
        __('Automation') => array(
        ...
        __('Configuration')  => array(
            ...
            'system_authorize.php'       => __('生成授权'),
            'system_authorize_user.php'       => __('查看授权'),
...
$user_auth_roles = array(
    __('顶部菜单')                         => array(8,7,21,18),
    __('常用管理')                         => array(3,40,4,5,41,42),
    __('模板管理')                         => array(10,11,12,17,19),
    __('常用功能')                         => array(25,22,1043),
    __('管理员功能')                        => array(24,23,14,16,15,1,2,13,26,9,101)
);
...
$user_auth_realm_filenames = array(
    ...
    'templates_import.php' => 16,
    'tree.php' => 4,
    'user_admin.php' => 1,
    'system_authorize.php' => 2,
    'system_authorize_user.php' => 2,
    'user_domains.php' => 1,
    ...
    'color_templates.php' => 19,
    'color_templates_items.php' => 19,
    'aggregate_templates.php' => 17,
...
$dsstats_database_bak_time = array(
    '0'  => __('凌晨0点'),
    '1' => __('凌晨1点'),
    '2' => __('凌晨2点'),
    '3' => __('凌晨3点'),
...
$navigation = array(
    ...
    'system_authorize.php:' => array(
        'title' => '生成授权',
        'mapping' => 'index.php:',
        'url' => 'system_authorize.php',
        'level' => '1'
    ),
    'system_authorize_user.php:' => array(
        'title' => '查看授权',
        'mapping' => 'index.php:',
        'url' => 'system_authorize_user.php',
        'level' => '1'
    ),
